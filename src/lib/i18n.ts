...
export const TRANSLATIONS = {
  sv: {
    ...
    corporatePost: {
      ...
      description: 'Fyll i formuläret nedan så tar vi hand om resten. Vi återkommer med bekräftelse inom 2–3 arbetsdagar.',
      ...
      infoBanner: 'Förfrågan skickas till ao@teknologkaren.se. Vi återkommer inom 2–3 arbetsdagar.',
  ...
  en: {
    ...
    corporatePost: {
      ...
      headingAccent: 'offer',
      description: 'Fill in the form below and we will take care of the rest. We will get back to you within 2–3 business days.',
      ...
      infoBanner: 'Your request will be sent to ao@teknologkaren.se. We will get back to you within 2–3 business days.',
