...
export const TRANSLATIONS = {
  sv: {
    ...
    footer: {
      ...
      builtBy: 'Byggd av TKL NEXUS-teamet',
      links: {
        students: 'För studenter',
        corporate: 'För företag',
        about: 'Om oss',
    ...
    events: {
      ...
      calendarPrevMonth: 'Föregående månad',
      calendarNextMonth: 'Nästa månad',
      calendarDayHasEvents: 'event denna dag',
      luddFetchError: 'Kunde inte hämta events från campus just nu.',
      luddNoEvents: 'Inga campus-events hittades just nu.',
      luddFallbackTitle: 'Campus-event',
      luddFallbackLocation: 'LUDD (Campus)',
      ctaSeeEvents: 'Se alla events',
      nexusFetchError: 'Kunde inte hämta events.',
      nexusFetchErrorOffline: 'Du verkar vara offline — kontrollera din anslutning.',
      emptyStateCta: 'Skicka in ditt event',
    ...
    corporate: {
      ...
      statsAriaLabel: 'Statistik om Teknologkåren',
      ctaBannerTitle: 'Redo att komma igång?',
    ...
    corporatePost: {
      ...
      deal: {
        ...
        logoUrl: 'Logotyp (valfritt)',
        logoUrlPlaceholder: 'https://foretag.se/logo.png',
        logoModeUrl: 'Länk',
        logoModeAttach: 'Bifoga',
        logoAttachHint: 'Bifoga logotypen direkt i mailet när det öppnas.',
      },
    ...
    opportunities: {
      ...
      noOpps: 'Lugnt just nu. Nya annonser publiceras löpande.',
      ...
      errorOffline: 'Du verkar vara offline — kontrollera din anslutning.',
      filters: {
        all: 'Alla Annonser',
        jobb: 'Jobb',
        exjobb: 'Exjobb',
    ...
    deals: {
      ...
      emptyStateCta: 'Är du företag? Publicera ett erbjudande',
      ...
      viewToggleAriaLabel: 'Välj visningsläge',
      copyCodeAriaLabel: 'Kopiera rabattkod:',
      drawerClose: 'Stäng',
  ...
  en: {
    ...
    events: {
      ...
      calendarDayHasEvents: 'has events',
      ...
      nexusFetchErrorOffline: 'You appear to be offline — check your connection.',
      emptyStateCta: 'Submit your event',
    ...
    corporate: {
      ...
      statsAriaLabel: 'Statistics about the student union',
      ctaBannerTitle: 'Ready to get started?',
    ...
    corporatePost: {
      ...
      deal: {
        ...
        logoModeUrl: 'URL',
        logoModeAttach: 'Attach',
        logoAttachHint: 'Attach the logo directly in the email when it opens.',
      },
      submit: 'Send request',
    ...
    deals: {
      ...
      emptyStateCta: 'Are you a company? Post an offer',
      ...
      viewIcons: 'Icons',
      viewDetails: 'Details',
      viewToggleAriaLabel: 'Choose view mode',
      copyCodeAriaLabel: 'Copy discount code:',
      drawerClose: 'Close',
